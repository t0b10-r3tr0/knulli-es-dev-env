...
sed -i "s|^KNULLI_EMULATIONSTATION_VERSION = .*|KNULLI_EMULATIONSTATION_VERSION = $CURRENT_EMULATIONSTATION_BRANCH|" $BASE_DIR/$LOCAL_DISTRIBUTION_DIR_NAME/package/knulli/knulli-emulationstation/knulli-emulationstation.mk
